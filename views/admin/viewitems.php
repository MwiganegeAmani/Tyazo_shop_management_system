...
<head>
    ...
    <title>Admin - items Search</title>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                   <thead>
                                    ...
                                    if (isset($_POST['btn'])) {
                                         $search = $_POST['search'];
$query = "select * from item where itemName LIKE '%$search%' OR stock LIKE '%$search%' OR unitPrice LIKE '%$search%' OR Price_jumla LIKE '%$search%' OR dateAdded LIKE '%$search%' OR description LIKE '%$search%' OR AddedBy LIKE '%$search%' OR updateBy LIKE '%$search%' OR updateDate LIKE '%$search%' order by itemID DESC";
