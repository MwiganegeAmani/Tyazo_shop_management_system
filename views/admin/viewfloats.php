...
<head>
    ...
    <title>Admin - view Senior floats</title>
...
<th>AddedBy</th>
                                   ...
                                   if (isset($_POST['btn'])) {
                                       $search = $_POST['search'];
    include '../../src/common/conn.php';
$query = "select * from seniortrans where transType = 'float' AND company like '%$search%' OR amount like '%$search%' OR floatRemain like '%$search%' OR phoneNo like '%$search%' OR date like '%$search%' OR addedBy like '%$search%' order by StransID DESC";
