...
<form method="post" action="viewcashs.php">
...
<th>AddedBy</th>
                                   ...
                                   if (isset($_POST['btn'])) {
                                       $search = $_POST['search'];
    include '../../src/common/conn.php';
$query = "select * from cash where transType = 'cash' AND company like '%$search%' OR amount like '%$search%' OR cashRemain like '%$search%' OR date like '%$search%' OR addedBy like '%$search%'  order by cashID DESC";
