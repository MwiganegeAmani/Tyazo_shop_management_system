...
$query = "select * from purchase where purchaseDate BETWEEN '$month' AND '$today' order by purchaseID DESC";
...
while ($row = mysqli_fetch_array($run)) {
                                ...
                                <h3>Sales</h3>
                                 <table id="datatable" class="table table-striped table-hover table-responsive">
                                    ...
                                    <?php 
$query = "select * from sales where saleDate BETWEEN '$month' AND '$today' order by saleID DESC";
$run = mysqli_query($con,$query);
while ($row = mysqli_fetch_array($run)) {
