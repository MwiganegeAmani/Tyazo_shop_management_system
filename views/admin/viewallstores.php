            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All Item's <small>DETAILS</small></h2>
                                <form method="post" action="viewallstores.php">
...
$query = "select * from product where PRODUCTCODE like '%$search%' OR QTY_STOCK like '%$search%' OR DATE_STOCK_IN like '%$search%' OR DESCRIPTION like '%$search%' OR ADDEDBY like '%$search%' OR UPDATEDBY like '%$search%' OR DATEUPDATED like '%$search%' order by id DESC";
$run = mysqli_query($con,$query);
while ($row = mysqli_fetch_array($run)) {
   
                                    ?>
                                    <tbody>
                                   <tr><td><?php echo $row['PRODUCTCODE']; ?></td>
