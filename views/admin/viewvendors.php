...
<head>
    ...
    <title>Admin - vendor search</title>
...
<form method="post" action="viewvendors.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All vendor's <small>DETAILS</small></h2> 
...
$query = "select * from vendor where fullName like '%$search%' OR email like '%$search%' OR mobile like '%$search%' OR phone2 like '%$search%' OR Address like '%$search%' OR registerDate like '%$search%' OR Status like '%$search%' OR registerBy like '%$search%' OR updateBy like '%$search%' OR updatedDate like '%$search%' order by vendorID DESC";
