...
$query = "select * from senior_cash where date ='$today' order by ScashID DESC";
...
$query = "select * from cash where date ='$today' order by cashID DESC";
$run = mysqli_query($con,$query);
while ($row = mysqli_fetch_array($run)) {
...
$query = "select * from seniortrans where date ='$today' order by StransID DESC";
$run = mysqli_query($con,$query);
while ($row = mysqli_fetch_array($run)) {
...
$query = "select * from transaction where date ='$today' order by transID DESC";
$run = mysqli_query($con,$query);
while ($row = mysqli_fetch_array($run)) {
