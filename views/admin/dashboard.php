    ...
    <div class="main_container">
        ...
        <!-- page content -->
           <div class="right_col" role="main" >
             <h3>SUMMARY</h3>
             <a href="todayreport.php" class="btn btn-info">Today Reports</a>
             <a href="weekreport.php" class="btn btn-primary">Weekly Reports</a>
             <a href="report.php" class="btn btn-success">Monthly Reports</a>
             <a href="agentreport.php" class="btn btn-warning">Today Agent Reports</a>
             <a href="weekagentReport.php" class="btn btn-info">Weekly Agent Reports</a>
             <a href="monthagentreport.php" class="btn btn-primary">Monthly Agent Reports</a>
             <hr>
            <div class="">
                <div class="row top_tiles">
                        ...
                        <div class="tile-stats">
                          ...
                          <div class="count">
                                 <?php
                                 $today = date('Y-m-d');
$query1 = "select * from purchase where purchaseDate = '$today'";
$run1 = mysqli_query($con,$query1);
echo mysqli_num_rows($run1);
                        ?>
                            </div>
                            <h3>All purchase Today</h3>
                            <p>There are <?php echo mysqli_num_rows($run1); ?> purchase today.</p>
                        </div>
                    </div>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                            ...
                            <div class="count">
                                 <?php
$query = "select * from sales where saleDate = '$today'";
$run = mysqli_query($con,$query);
echo mysqli_num_rows($run);
                        ?>
                            </div>
                            <h3>All Sales Today</h3>
                            <p>There are <?php echo mysqli_num_rows($run); ?> Sales today.</p>
                        </div>
                    </div>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
...
echo mysqli_num_rows($run1);
                        ?>
                            ...
                            <h3>All Vendors</h3>
                            <p>There are <?php echo mysqli_num_rows($run1); ?> Vendors.</p>
                        </div>
                    </div>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                   ...
                   <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count">
                                 <?php
                                 $today = date('Y-m-d');
$query11 = "select * from item where dateAdded = '$today'";
$run11 = mysqli_query($con,$query11);
echo mysqli_num_rows($run11);
                        ?>
                            </div>
                            <h3>All Items Today</h3>
                            <p>There are <?php echo mysqli_num_rows($run11); ?> Items Added today.</p>
                        </div>
                    </div>
                </div>
