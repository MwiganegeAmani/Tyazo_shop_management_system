...
<form method="post" action="viewemployeessearch.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All User's <small>DETAILS</small></h2> <a href="../employee/createEmployee.php" class="btn btn-info">Add User</a>
                            ...
                            <div class="x_content">
                                ...
                                <thead>
                                    ...
                                    if ($_POST['search']) {
                                        include '../../src/common/conn.php';
                                        $search = $_POST['search'];
$query = "select * from users where fullName like '%$search%' OR userName like '%$search%' OR DOB like '%$search%' OR phone like '%$search%' OR Status like '%$search%' OR Role like '%$search%' OR dateCreated like '%$search%' order by userID desc";
...
while ($row = mysqli_fetch_array($run)) {
                                   ...
                                   <td><?php echo $row['Status']; ?></td>
                                    ...
                                    <td><a href="update.php?id=<?php echo $row['userID']; ?>" type="button" class="btn btn-info">Update</td>
                                     <td><a href="../../src/common/delete.php?empdeleteid=<?php echo $row['userID']; ?>" type="button" class="btn btn-danger">Delete</td>
                                     </tr>
                                    </tbody>
                                <?php } } ?>
                                </table>
