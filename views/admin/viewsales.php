...
<head>
    ...
    <title>Admin - sales Search</title>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                   <thead>
                                    ...
                                    if (isset($_POST['btn'])) {
                                         $search = $_POST['search'];
$query = "select * from sales where itemName LIKE '%$search%' OR quantity LIKE '%$search%' OR unitPrice LIKE '%$search%' OR totalPrice LIKE '%$search%' OR saleDate LIKE '%$search%' OR userSale LIKE '%$search%' OR updateDate LIKE '%$search%' OR updateDate LIKE '%$search%'  order by saleID DESC";
