                ...
                <div class="row top_tiles">
                        ...
                        <div class="tile-stats">
                            ...
                            <div class="count">
                                 <?php
                                 $today = date('Y-m-d');
$query1 = "select * from purchase where addedBy = '".$_SESSION['userName']."' AND purchaseDate = '$today'";
...
echo mysqli_num_rows($run1);
                      ...
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                            ...
                            <div class="count">
                                 <?php
$query1 = "select * from sales where userSale = '".$_SESSION['userName']."' AND saleDate = '$today'";
$run1 = mysqli_query($con,$query1);
echo mysqli_num_rows($run1);
                        ?>
                            </div>
                            <h3>All Sales Today</h3>
                            <p>There are <?php echo mysqli_num_rows($run1); ?> Sales today.</p>
                        </div>
                    </div>
                      <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
...
echo mysqli_num_rows($run1);
                        ...
                        <div class="tile-stats">
                          ...
                          <div class="count">
                                 <?php
                                 $today = date('Y-m-d');
$query11 = "select * from item";
$run11 = mysqli_query($con,$query11);
echo mysqli_num_rows($run11);
                        ?>
                            </div>
                            <h3>All Items</h3>
                            <p>There are <?php echo mysqli_num_rows($run11); ?> Items Added.</p>
                        </div>
                    </div>
