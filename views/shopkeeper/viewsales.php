...
<head>
    ...
    <title>shopkeeper - sales Search</title>
...
<form method="post" action="viewsales.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                     <a href="../shopkeeper/addsales.php" class="btn btn-info">Add sales</a>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                   <thead>
                                    ...
                                    if (isset($_POST['btn'])) {
                                         $search = $_POST['search'];
$query = "select * from sales where itemName LIKE '%$search%' OR quantity LIKE '%$search%' OR unitPrice LIKE '%$search%' OR totalPrice LIKE '%$search%' OR saleDate LIKE '%$search%' AND userSale = '".$_SESSION['userName']."'  order by saleID DESC";
...
while ($row = mysqli_fetch_array($run)) {
                                  ...
                                  <tbody>
                                   <tr><td><?php echo $row['itemName']; ?></td>
                                    ...
                                    <td><a href="updatesale.php?CUST_ID=<?php echo $row['saleID']; ?>" type="button" class="btn btn-info">Update</td>
                                     <td><a href="deletesale.php?CUST_ID=<?php echo $row['saleID']; ?>" type="button" class="btn btn-danger">Delete</td>
                                     </tr>
                                    </tbody>
                                <?php } } 
     ?>
