...
<head>
    ...
    <title>Shopkeeper - vendor search</title>
...
$query = "select * from vendor where fullName like '%$search%' OR email like '%$search%' OR mobile like '%$search%' OR phone2 like '%$search%' OR Address like '%$search%' OR registerDate like '%$search%' OR Status like '%$search%'  AND registerBy = '".$_SESSION['userName']."' order by vendorID DESC";
