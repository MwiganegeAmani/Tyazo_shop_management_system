...
<head>
    ...
    <title>Shopkeeper - update Sales</title>
...
<div class="container body">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Put your transaction's detail's correctly</h2>
 ...
 <?php 
    include '../../src/common/conn.php';
        $id = $_GET['CUST_ID'];
$query1 = "select * from sales where saleID = $id";
$run1 = mysqli_query($con,$query1);
$ro = mysqli_fetch_array($run1);
   
                                    ?>
                        
                                    <span class="section">Sale's Info</span>
                                            <?php 
              if (isset($_POST['send'])) {
...
$NAME = $_SESSION['userName'];
    ...
    if ($itemname !="" && $quantity!=""  && $totalprice!="") {
      $query3 = "UPDATE sales SET itemName = '$itemname',quantity = '$quantity',unitPrice='$unitprice', totalPrice = '$totalprice',userUpdate = '$usersale',updateDate = '$date' WHERE saleID = '$id'";
      $res = mysqli_query($con,$query3);

      $trigger = "INSERT INTO messages VALUES ('','SalesUpdated','$NAME was update a sale,  from ".$ro['itemName']." to $itemname!,".$ro['quantity']." to $quantity,".$ro['unitPrice']." to $unitprice,".$ro['totalPrice']." to $totalprice','$date','$today','')";
       $triggerquery = mysqli_query($con,$trigger);
    if ($res) {
      echo "<div class='alert alert-success'>Congratulation! Transaction's details are updated Successfully...</div>";
    }
    else{
      echo "<div class='alert alert-danger'>Aghrrrr! Transaction's details are not updated Successfully , Please repeate again!</div>";
    }
    }
...
while ($row = mysqli_fetch_array($run)) {
  ...
  <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="firstName" class="form-control col-md-7 col-xs-12" name="quantity" value="<?php echo $ro['quantity']; ?>" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="lastName" class="form-control col-md-7 col-xs-12" name="totalprice" value="<?php echo $ro['totalPrice']; ?>" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a href="viewsale.php" type="btn" class="btn btn-primary">Back</a>
