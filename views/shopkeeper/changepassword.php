...
<head>
    ...
    <title>Shopkeeper - Change Password</title>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="changepassAction.php" method="post" class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="noticeSubject">User Name <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="noticeSubject" class="form-control col-md-7 col-xs-12" name="username" placeholder="Your User Name" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="item form-group">
