...
$query1 = "select * from vendor where vendorID= $id";
...
<head>
    ...
    <title>Shopkeeper - Update Vendor</title>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Update your vendor detail's information correctly</h2>
...
$NAME = $_SESSION['userName'];
 $today = date('h:i:sa');
    if ($fullname !="" && $mobile!=""  && $address!="") {
      $query = "update vendor set fullName = '$fullname',email = '$email',mobile = '$mobile',phone2 = '$mobile2',Address = '$address', updatedDate = '$date',updateBy = '$NAME' where vendorID = $id";
      $res = mysqli_query($con,$query);


$trigger = "INSERT INTO messages VALUES ('','vendorUpdated','$NAME was update a vendor ,  from ".$ro['fullName']." to $fullname!','$date','$today','')";
       $triggerquery = mysqli_query($con,$trigger);
    if ($res) {
      echo "<div class='alert alert-success'>Congratulation! Purchase Transaction Is Updated Successfully!</div>";
    }
    else{
                                ...
                                ?>
                                   ...
                                   <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="lastName" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="fullname" value="<?php echo $ro['fullName']; ?>" required="required" type="text">
                                        </div>
                                    </div>
                                       <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="lastName">Email:</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="lastName" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo $ro['email']; ?>" type="email">
                                        </div>
                                    </div>
                                       <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="tel" id="number" name="mobile" required="required" data-validate-minmax="10,100" value="<?php echo $ro['mobile']; ?>" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                     <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="tel" id="number" name="mobile2"  data-validate-minmax="10,100" value="<?php echo $ro['phone2']; ?>" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                  <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="text" name="address" required="required" value="<?php echo $ro['Address']; ?>" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
