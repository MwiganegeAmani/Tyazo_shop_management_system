...
<head>
    ...
    <title>Shopkeeper - purchases</title>
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3>All Purchases Transactions</h3>
                    </div>
<form method="post" action="viewpurchases.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                <a href="../shopkeeper/addpurchase.php" class="btn btn-info">Add purchase</a>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                    ...
                                    <?php 
$query = "select * from purchase where addedBy = '".$_SESSION['userName']."' order by purchaseID DESC";
