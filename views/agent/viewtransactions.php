...
<head>
    ...
    <title>Agent - view Transaction search</title>
...
$query = "select * from purchase where itemName like '%$search%' OR quantity like '%$search%' OR unitPrice like '%$search%' OR totalPrice like '%$search%' OR vendorName like '%$search%' OR purchaseDate like '%$search%' OR addedBy like '%$search%' OR updateDate like '%$search%' OR updateBy like '%$search%' AND addedBy = '".$_SESSION['userName']."' order by purchaseID DESC";
...
while ($row = mysqli_fetch_array($run)) {
                                   ...
                                   <tr><td><?php echo $row['itemName']; ?></td>
                                    ...
                                    <td><a href="updatepurchase.php?TRANS_ID=<?php echo $row['purchaseID']; ?>" type="button" class="btn btn-info">Update</td>
                                     <td><a href="deletepurchase.php?TRANS_ID=<?php echo $row['purchaseID']; ?>" type="button" class="btn btn-danger">Delete</td>
                                     </tr>
                                    </tbody>
                                <?php } ?>
                                </table>
