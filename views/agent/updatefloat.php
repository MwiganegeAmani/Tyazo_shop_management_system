...
<head>
    ...
    <title>Agent - update float</title>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Put your float detail's correctly</h2>
...
$ro = mysqli_fetch_array($run1);
                                    ...
                                    <span class="section">float's Info</span>
                                            <?php 
              if (isset($_POST['send'])) {
    ...
    if ($floattype !="" && $amount!="") {
      $query3 = "UPDATE floata SET floatType = '$floattype',amount = '$amount',updateDate='$date', updateBy = '$addedby' WHERE floatID = '$id'";
      $res = mysqli_query($con,$query3);

      $trigger = "INSERT INTO messages VALUES ('','FloatUpdated','$addedby was update a Float,  from ".$ro['floatType']." to $floattype!,".$ro['amount']." to $amount','$date','$time','')";
       $triggerquery = mysqli_query($con,$trigger);
    if ($res) {
      echo "<div class='alert alert-success'>Congratulation! A Float's details is updated Successfully...</div>";
    }
    else{
      echo "<div class='alert alert-danger'>Aghrrrr! A Float's details is not updated Successfully , Please repeate again!</div>";
    }
    }
                                ...
                                ?>
                                        ...
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="firstName">company Type: <span class="required">*</span>
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="department" name="companytype" class="form-control col-md-7 col-xs-12">
               ...
               <option value="mpesa">M-PESA</option>
                ...
                <option value="tigopesa">TIGOPESA</option>
                                     ...
                                     <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="firstName" class="form-control col-md-7 col-xs-12" name="transtype" value="<?php echo $ro['transType']; ?>" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a href="viewjunior.php" type="btn" class="btn btn-primary">Back</a>
