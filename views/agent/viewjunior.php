                        ...
                        <div class="x_panel">
                            <div class="x_title">
                             <a href="../agent/addfloat1.php" class="btn btn-info">Add float</a>
                              <a href="../agent/addcash1.php" class="btn btn-success">Add Cash</a>
                               <a href="../agent/addcashtransaction1.php" class="btn btn-dark">Add Transaction</a>                             
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                    ...
                                    <tr>
                                      ...
                                      <?php 
$query = "select * from transaction where addedBy = '".$_SESSION['userName']."' AND transType = 'float' order by transID DESC";
