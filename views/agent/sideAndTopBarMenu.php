...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="../agent/dashboard.php" class="site_title"><i style="color: #000" class="fa fa-home"></i> <span style="color: #000;">Tyazo Mdodo</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-user"></i> Agent <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../agent/viewsenior.php">Senior Agent</a></li>
                            <li><a href="../agent/viewjunior.php">Junior Agent</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
