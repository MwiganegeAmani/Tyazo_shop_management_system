...
$queryq = "SELECT `cashRemain` as max FROM `senior_cash` where company = '$companytype' order by ScashID desc";
...
<head>
    ...
    <title>Senior Agent - Add Cash</title>
...
<div class="container body">
    ...
    if ($amount !="" && $cashnow!="") {
      $query = "INSERT INTO senior_cash VALUES ('','$company','cash','$amount','$cashnow','$date','$time','$addedBy','','')";
