...
$query = "SELECT `cashRemain` as max FROM `cash` where company = '$companytype' order by cashID desc";
$runq = mysqli_query($con,$query);
$row1 = mysqli_fetch_array($runq);
$queryq = "SELECT `floatRemain` as maxtrans FROM `transaction` where company = '$companytype' order by transID desc";
...
<div class="container body">
    ...
    $floatnow = $floatremain-$amount;
      $query = "INSERT INTO cash VALUES ('','$company','$transtype','$amount','$floatnow','$date','$time','$addedBy','','')";
      $res = mysqli_query($con,$query);
 $query = "INSERT INTO transaction VALUES ('','$company','$transtype','$amount','$float','$phone','$date','$time','$addedBy','','')";
      $res = mysqli_query($con,$query);
