...
<head>
    ...
    <title>Senior Agent - Add Float</title>
...
<div class="container body">
    ...
    if ($amount !="" && $phone!="") {
      $query = "INSERT INTO seniortrans VALUES ('','$company','float','$amount','$floatnow','$phone','$date','$time','$addedBy','','')";
      $res = mysqli_query($con,$query);

      //   $query3 = "UPDATE floata SET amount = '$amount',updateDate='$date', updateBy = '$addedby' WHERE floatID = '$id'";
      // $res3 = mysqli_query($con,$query3);
    if ($res) {
      echo "<div class='alert alert-success'>Congratulation! A Float is Added Successfully...<br>Float Remain: Tshs. $floatnow</div>";
    }
    else{
      echo "<div class='alert alert-danger'>Aghrrrr! A Float is not Added Successfully , Please repeate again!</div>";
    }
    }
