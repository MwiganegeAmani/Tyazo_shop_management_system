...
$queryq = "SELECT `floatRemain` as max FROM `seniortrans` where company = '$companytype' order by StransID desc";
...
<div class="container body">
    ...
    if ($transtype !="" && $phone!="") {
      $query = "INSERT INTO seniortrans VALUES ('','$company','$transtype','$amount','$floatnow','$phone','$date','$time','$addedBy','','')";
      $res = mysqli_query($con,$query);

      //   $query3 = "UPDATE floata SET amount = '$amount',updateDate='$date', updateBy = '$addedby' WHERE floatID = '$id'";
      // $res3 = mysqli_query($con,$query3);
    if ($res) {
      echo "<div class='alert alert-success'>Congratulation! A Transaction is Added Successfully..<br>Float Remain: Tshs. $floatnow</div>";
    }
    else{
      echo "<div class='alert alert-danger'>Aghrrrr! A Transaction is not Added Successfully , Please repeate again!</div>";
    }
    }
                                ...
                                ?>
                                     ...
                                     <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="firstName" class="form-control col-md-7 col-xs-12" name="transtype" placeholder="Mfano. Kutoa" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="firstName" class="form-control col-md-7 col-xs-12" name="phone" placeholder="Eg. 0767675867" required="required" type="text">
                                        </div>
                                    </div>
