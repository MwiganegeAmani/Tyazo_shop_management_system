...
<head>
    ...
    <title>junior - view information</title>
...
<form method="post" action="viewfloats.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                             <a href="../agent/addfloat1.php" class="btn btn-info">Add float</a>
                             <a href="../agent/addtransaction1.php" class="btn btn-primary">Add transaction</a>
                ...
                <?php
                  if (isset($_POST['btn'])) {
                                         $search = $_POST['search'];
$query = "select * from transaction where amount LIKE '%$search%' OR date LIKE '%$search%' OR time LIKE '%$search%' OR floatRemain LIKE '%$search%' OR phoneNo LIKE '%$search%' AND addedBy = '".$_SESSION['userName']."' AND transType='float' order by transID DESC";
...
while ($row = mysqli_fetch_array($run)) {
                                   ...
                                   <tr><td><?php echo $row['company']; ?></td>
                                    ...
                                    <td><a href="updatetransaction.php?TRANS_ID=<?php echo $row['transID']; ?>" type="button" class="btn btn-info">Update</a>
                                        <a href="viewtransaction.php?TRANS_ID=<?php echo $row['transID']; ?>" type="button" class="btn btn-primary">View Transactions</a></td>
                                     </tr>
                                    </tbody>
                                <?php } } ?>
                                </table>
