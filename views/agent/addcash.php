...
$queryq = "SELECT `cashRemain` as max FROM `cash` where company = '$companytype' order by cashID desc";
...
<div class="container body">
    ...
    if ($amount !="" && $cashnow!="") {
      $query = "INSERT INTO cash VALUES ('','$company','cash','$amount','$cashnow','$date','$time','$addedBy','','')";
