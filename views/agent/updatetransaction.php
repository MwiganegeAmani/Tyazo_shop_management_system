...
$queryq = "SELECT * FROM `transaction` where transID = '$companytype'";
...
<head>
    ...
    <title>Agent - Update transaction</title>
...
<div class="container body">
    ...
    if ($transtype !="" && $phone!="") {
      $query = "INSERT INTO messages VALUES ('','TransactionUpdated','$addedBy was update a transaction from ".$row1['company']." to $company, ".$row1['transType']." to $transtype,".$row1['floatRemain']." to $floatremain,".$row1['amount']." to $amount','$date','$time','')";
      $res = mysqli_query($con,$query);

        $query3 = "UPDATE transaction SET amount = '$amount',company='$company', floatRemain = '$floatremain',transType='$transtype',phoneNo='$phone',UpdatedBy='$addedBy',company='$company',updateDate='$date' WHERE transID = '$companytype'";
