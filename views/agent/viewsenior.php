...
<head>
    ...
    <title>Senior - view information</title>
...
<form method="post" action="viewseniorfloats.php">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                             <a href="../agent/addseniorfloat1.php" class="btn btn-info">Add float</a>
                              <a href="../agent/addseniorcash1.php" class="btn btn-success">Add Cash</a>
                               <a href="../agent/addseniorcashtransaction1.php" class="btn btn-dark">Add Transaction</a>
                             <!-- <a href="../agent/addseniortransaction1.php" class="btn btn-primary">Add transaction</a> -->
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                    ...
                                    <tr>
                                      ...
                                      <?php 
$query = "select * from seniortrans where addedBy = '".$_SESSION['userName']."' AND transType = 'float' order by StransID DESC";
...
while ($row = mysqli_fetch_array($run)) {
                                   ...
                                   <tr><td><?php echo $row['company']; ?></td>
                                    ...
                                    <td><?php echo "0".$row['phoneNo']; ?></td>
                                    <td><?php echo $row['date']; ?></td>
                                     <td><?php echo $row['time']; ?></td>
                        
                                    <td><a href="updateseniortransaction.php?TRANS_ID=<?php echo $row['StransID']; ?>" type="button" class="btn btn-info">Update</a>
                                        <a href="viewseniortransaction.php?TRANS_ID=<?php echo $row['StransID']; ?>" type="button" class="btn btn-primary">View Transactions</a></td>
                                     </tr>
                                    </tbody>
                                <?php } ?>
                                </table>
