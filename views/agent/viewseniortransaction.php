...
include '../../src/common/conn.php';
 $id = $_GET['TRANS_ID'];
$query1 = "select * from seniortrans where StransID = $id";
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered table-responsive">
                                    ...
                                    <?php 
                                    $company = $ro['company'];
$query = "select * from seniortrans where addedBy = '".$_SESSION['userName']."' AND company = '$company' order by StransID DESC";
