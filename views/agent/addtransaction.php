...
$queryq = "SELECT `floatRemain` as max FROM `transaction` where company = '$companytype' order by transID desc";
...
<div class="container body">
    ...
    if ($transtype !="" && $phone!="") {
      $query = "INSERT INTO transaction VALUES ('','$company','$transtype','$amount','$floatnow','$phone','$date','$time','$addedBy','','')";
